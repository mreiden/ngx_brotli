/*
 * SHA-256 (FIPS 180-4) for hashing dcb dictionaries at config load.
 *
 ...
 * (NGX_HTTP_BROTLI_HAVE_LIBCRYPTO), the one-shot entry point uses
...
#if (NGX_HTTP_BROTLI_HAVE_LIBCRYPTO)
